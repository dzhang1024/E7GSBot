...
async def gs(ctx, stat1, stat2, stat3, stat4):
  ...
  if stat1[0:3] == 'spd' or stat1[0:2] == 'cc' or stat1[0:2] == 'cd' or stat1[
      0:3] == 'att' or stat1[0:3] == 'def' or stat1[0:2] == 'hp':
    if stat1[0:3] == 'spd':
  ...
  if stat2[0:3] == 'spd' or stat2[0:2] == 'cc' or stat2[0:2] == 'cd' or stat2[
      0:3] == 'att' or stat2[0:3] == 'def' or stat2[0:2] == 'hp':
    if stat2[0:3] == 'spd':
      ...
      second = float(stat2[3:]) / 10
    elif stat2[0:3] == 'def':
      second = float(stat2[3:]) / 6
    elif stat2[0:2] == 'hp':
      second = float(stat2[2:]) / 50
  else:
    second = float(stat2)

  if stat3[0:3] == 'spd' or stat3[0:2] == 'cc' or stat3[0:2] == 'cd' or stat3[
      0:3] == 'att' or stat3[0:3] == 'def' or stat3[0:2] == 'hp':
    if stat3[0:3] == 'spd':
      ...
      third = float(stat3[3:]) / 10
    elif stat3[0:3] == 'def':
      third = float(stat3[3:]) / 6
    elif stat3[0:2] == 'hp':
      third = float(stat3[2:]) / 50
  else:
    third = float(stat3)

  if stat4[0:3] == 'spd' or stat4[0:2] == 'cc' or stat4[0:2] == 'cd' or stat4[
      0:3] == 'att' or stat4[0:3] == 'def' or stat4[0:2] == 'hp':
    if stat4[0:3] == 'spd':
      ...
      fourth = float(stat4[3:]) / 10
    elif stat4[0:3] == 'def':
      fourth = float(stat4[3:]) / 6
    elif stat4[0:2] == 'hp':
      fourth = float(stat4[2:]) / 50
  else:
    fourth = float(stat4)
